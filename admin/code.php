<?php
    ...
    if(isset($_POST['post-update']))
    {
        ...
        $query = " UPDATE posts SET category_id ='$category_id',name='$name',slug='$slug', description='$description',image='$update_filename', meta_title = '$meta_title',
    ...
    if(isset($_POST['post-add'])){
        ...
        if($query_run){
            move_uploaded_file($_FILES['image']['tmp_name'],  'sam-blog/uploads/posts'.$filename);
