                                ...
                                <form action="code.php" method="POST" enctype="multipart/form-data" >
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <textarea name="description" id="summernote" required  class="form-control" row="4" ><?=htmlentities($post_row['description']); ?></textarea>
                                        </div>
                                        ...
                                        <div class="col-md-12 mb-3">
                                            <button type="submit" name="post-update" class="btn btn-primary">Update Posts</button>
                                        </div>
